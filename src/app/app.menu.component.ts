...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {label: 'Kontakte', icon: 'account_box', routerLink: ['/customer']},
            {
            ...
            {label: 'webSDPS' , command : () => this.toWebSdps()}
        ];
    }
    ...
    public toWebSdps(): void {
        location.href = 'https://websdps.de.scania.local/sdps2/app/user/info.faces';
    }
}
